export default {
  ...
  features: {
    ...
    brokerage: {
      ...
      box2: {
        title: 'IDV',
        list: {
          list1: 'Verify client identity remotely',
      ...
      box9: {
        ...
        list: {
          list1: 'Multiple options',
          list2: 'Recurring payments',
        },
      },
      box10: {
        title: 'Direct Deposit',
        list: {
          list1: 'Pay transaction online',
          list2: 'Bank integration',
        },
      },
      box11: {
        title: 'Accounting',
        list: {
          list1: 'QBO integration',
          list2: 'Easy synchronization',
        },
      },
      box12: {
        title: 'Reporting',
      ...
      box13: {
        title: 'Government Tax Return',
        list: {
          list1: 'Income reporting',
          list2: 'Income slip',
        },
      },
      box14: {
        title: 'Ledgers',
        list: {
          list1: 'Agent/Listing/Transaction',
          list2: 'Trust/Disclosure',
        },
      },
      box15: {
        title: 'Client Access',
  ...
  privacy_policy: {
    heading: "Privacy Policy of docem.ca",
    title: "Site Type: Real Estate",
    date: "Effective Date: December 25, 2023",
    text1: "docem.ca (the \"Site\") is owned and operated by BACC Solutions Inc. BACC Solutions",
    text2: "Inc can be contacted at:",
    ...
    heading2: "Purpose",
    text4: "The purpose of this Privacy Policy (the \"Privacy Policy\") is",
    text5: "to inform users of our Site about the following:",
    Ol1Li1: "The personal data we will collect",
    Ol1Li2: "How the collected data will be used",
    Ol1Li3: "Who has access to the collected data",
    Ol1Li4: "User rights on the Site",
    Ol1Li5: "The Site's cookie policy",
    text6: "This Privacy Policy applies in addition to the general terms of use of our Site.",
    heading3: "Consent",
    text7: "Users agree that by using our Site, they consent to the following:",
    Ol2Li1: "The conditions outlined in this Privacy Policy",
    Ol2Li2: "The collection, use, and storage of data as outlined in this policy.",
    heading4: "How we use personal data",
    text8: "Personal data collected on our Site will be used only for the purposes specified in this Privacy Policy or indicated on the relevant pages of our Site. We will not use your data beyond what is disclosed in this Privacy Policy.",
    heading5: "With whom we share personal data",
    text9: "Employees",
    text10: "We may disclose to any member of our organization the user data they reasonably need to achieve the objectives outlined in this Privacy Policy.",
    text11: "Other disclosures",
    text12: "We will not sell or share your data with any third parties, except in the following cases:",
    Ol3Li1: "If required by law;",
    Ol3Li2: "If required for any legal proceedings;",
    Ol3Li3: "To prove or protect our rights; and",
    Ol3Li4: "To buyers or potential buyers of this company in case we seek to sell the company.",
    text13: "If you follow hyperlinks from our Site to another site, please note that we are not responsible and have no control over their privacy policies and practices.",
    heading6: "How long we store personal data",
    text14: "User data will not be retained beyond what is necessary to achieve the purposes for which it was collected.",
    text15: "We will ensure to notify you if your data is retained for a longer period.",
    heading7: "How we protect your personal data",
    ...
    text17: "While we take all reasonable precautions to ensure that our user data is secure and that users are protected, there is always a risk of harm. The Internet as a whole can sometimes be insecure, and we therefore cannot guarantee the security of user data beyond what is reasonably practical.",
    heading8: "Minors",
    text18: "We do not knowingly collect or use personal data from children under 13. If we learn that we have collected personal data from a child under 13, that personal data will be deleted as soon as possible. If a child under 13 has provided us with personal data, their parents or guardian can contact our privacy officer.",
    heading9: "How to modify, delete, or contest collected data",
    text19: "If you wish to know if we have collected your personal data, how we have used it, if we have disclosed it, and to whom we have disclosed it, or if you want your data to be deleted or modified in any way, please contact our privacy officer here:",
    linkText3: "privacy@docem.net",
    heading10: "How to refuse the collection, use, or disclosure of data",
    text20: "In addition to the methods described in the section How to modify, delete, or contest collected data, we offer the following specific opt-out methods for forms of collection, use, or disclosure of your personal data:",
    Ol4Li1: ". You can unsubscribe as follows: unsubscribe.",
    heading11: "Cookie Policy",
    text21: "A cookie is a small file stored on a user's hard drive by the Website. Its purpose is to collect data about user browsing habits. You can choose to be notified each time a cookie is transmitted. You can also choose to disable cookies entirely in your Internet browser, but this may reduce the quality of your user experience. We use the following types of cookies on our Site:",
    Ol5Li1: ". You can unsubscribe as follows: unsubscribe.",
    text22: "Functional cookies are used to remember the selections you make on our Site so that your selections are saved on your next visits.",
    heading12: "Changes",
    text23: "This Privacy Policy may be amended from time to time to maintain compliance with the law and to account for any changes to our data collection process. When we modify this Privacy Policy, we update the \"Effective Date\" at the top of this Privacy Policy. We recommend that our users check our Privacy Policy from time to time to ensure they are informed of any updates. If necessary, we may inform users by email of changes to this Privacy Policy.",
    heading13: "Contact",
    text24: "If you have any questions, feel free to contact our privacy officer, __________ at: privacy@docem.net",
  ...
  terms_of_services: {
    text1: "Due to the introduction of Quebec Bill 96, you should make sure that all parties to your contract are okay with the language of the contract being in English and have seen a French version of the contract before signing the English version. If you do not provide a French version of the contract and the other party suffers as a result, the contract can be declared to have no legal effect or they can seek to recover their losses from you.",
    text2: "You will find a French version of your contract included before the English version. Any answers that you provided in English in the questionnaire have not been translated to French. You should consider providing a French translation of any important or long answers that you provided in English using Google Translate.",
    ...
    text4: "If the parties choose to have the language of the contract as French, you should instead go to https://www.lawdepot.ca/contracts/bail-commercial/?loc=CA and reenter your answers for a French contract.",
    text5: "Acknowledgement of English Language Contract",
    text6: "have seen a French and an English version of the Website Terms and conditions dated December 25, 2023 and am choosing to enter this contract exclusively in English.",
    heading1: "TERMS AND CONDITIONS",
    text7: 'These terms and conditions (the "Terms and Conditions") govern the use of docem.ca (the "Site"). This Site is owned and operated by BACC Solutions Inc. This Site is a real estate.',
    text8: 'By using this Site, you indicate that you have read and understand these Terms and Conditions and agree to abide by them at all times.',
    heading2: "Intellectual Property",
    text9: 'All content published and made available on our Site is the property of BACC Solutions Inc and the Site\'s creators. This includes, but is not limited to images, text, logos, documents, downloadable files and anything that contributes to the composition of our Site.',
    heading3: "of our Site.Acceptable Use",
    text10: 'As a user of our Site, you agree to use our Site legally, not to use our Site for illegal purposes, and not to:',
    text11: 'If we believe you are using our Site illegally or in a manner that violates these Terms and Conditions, we reserve the right to limit, suspend or terminate your access to our Site. We also reserve the right to take any legal steps necessary to prevent you from accessing our Site.',
    heading4: "Accounts",
    text12: 'When you create an account on our Site, you agree to the following: You are solely responsible for your account and the security and privacy of your account, including passwords or sensitive information attached to that account; and All personal information you provide to us through your account is up to date, accurate, and truthful and that you will update your personal information if it changes. We reserve the right to suspend or terminate your account if you are using our Site illegally or if you violate these Terms and Conditions.',
    heading5: "Sale of Services",
    text13: 'These Terms and Conditions govern the sale of services available on our Site. The following services are available on our Site:',
    ol1Li1: "Forms & eSignature;",
    ol1Li2: "IDV;",
    ol1Li3: "Offer Management;",
    ol1Li4: "Transaction Management; et",
    ol1Li5: "Showings.",
    text14: 'The services will be paid for in full when the services are ordered. These Terms and Conditions apply to all the services that are displayed on our Site at the time you access it. All information, descriptions, or images that we provide about our services are as accurate as possible. However, we are not legally bound by such information, descriptions, or images as we cannot guarantee the accuracy of all services we provide. You agree to purchase services from our Site at your own risk. We reserve the right to modify, reject or cancel your order whenever it becomes necessary. If we cancel your order and have already processed your payment, we will give you a refund equal to the amount you paid. You agree that it is your responsibility to monitor your payment instrument to verify receipt of any refund.',
    heading6: "Subscriptions",
    text15: 'Your subscription automatically renews and you will be automatically billed until we receive notification that you want to cancel the subscription. To cancel your subscription, please follow these steps:',
    heading7: "Payments",
    text16: 'We accept the following payment methods on our Site: Credit Card. When you provide us with your payment information, you authorize our use of and access to the payment instrument you have chosen to use. By providing us with your payment information, you authorize us to charge the amount due to this payment instrument. If we believe your payment has violated any law or these Terms and Conditions, we reserve the right to cancel or reverse your transaction.',
    heading8: "Consumer Protection Law",
    text17: 'Where the Consumer Protection Act, or any other consumer protection legislation in your jurisdiction applies and cannot be excluded, these Terms and Conditions will not limit your legal rights and remedies under that legislation. These Terms and Conditions will be read subject to the mandatory provisions of that legislation. If there is a conflict between these Terms and Conditions and that legislation, the mandatory provisions of the legislation will apply.',
    heading9: "Limitation of Liability",
    text18: 'BACC Solutions Inc and our directors, officers, agents, employees, subsidiaries, and affiliates will not be liable for any actions, claims, losses, damages, liabilities and expenses including legal fees from your use of the Site.',
    heading10: "Indemnity",
    text19: 'Except where prohibited by law, by using this Site you indemnify and hold harmless BACC Solutions Inc and our directors, officers, agents, employees, subsidiaries, and affiliates from any actions, claims, losses, damages, liabilities and expenses including legal fees arising out of your use of our Site or your violation of these Terms and Conditions.',
    heading11: "Applicable Law",
    text20: 'These Terms and Conditions are governed by the laws of the Province of Quebec.',
    heading12: "Severability",
    text21: 'If at any time any of the provisions set forth in these Terms and Conditions are found to be inconsistent or invalid under applicable laws, those provisions will be deemed void and will be removed from these Terms and Conditions. All other provisions will not be affected by the removal and the rest of these Terms and Conditions will still be considered valid.',
    heading13: "Changes",
    text22: 'These Terms and Conditions may be amended from time to time in order to maintain compliance with the law and to reflect any changes to the way we operate our Site and the way we expect users to behave on our Site. We will notify users by email of changes to these Terms and Conditions or post a notice on our Site.',
    heading14: "Changes",
    text23: 'Please contact us if you have any questions or concerns. Our contact details are as follows:',
    text24: 'You can also contact us through the feedback form available on our Site. Effective Date: 25th day of December, 2023',
  },
}
